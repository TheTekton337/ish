...
lib.resource.add('hterm/test/messages', 'raw',
{
	...
	"HTERM_BUTTON_NEXT": {
		"description": "Button label for moving to the next found entry when finding text in the terminal output.",
		"message": "Next"
	},
	...
	"HTERM_BUTTON_PREVIOUS": {
		"description": "Button label for moving to the previous found entry when finding text in the terminal output.",
		"message": "Previous"
	},
	...
	"SSH_CERT_CHECK_ERROR": {
		"description": "Error message shown to the user when checking the SSH certificate status failed. The message parameter will come directly from the OS or other programs and might be a translated string itself.",
		"message": " failed: $MSG$",
		"placeholders": {
			"MSG": {
				"content": "$1",
	...
	"SSH_CERT_CHECK_RESULT": {
		"description": "Status message shown to the user after checking the expiration time of the user's SSH certificates (credentials). The ~ indicates the time is a rough approximation. Everything here may be translated or adjusted as makes sense.",
	...
	"SSH_CERT_CHECK_START": {
		"description": "Status message shown to the user when we start to check the expiration time of the user's SSH certificates (credentials). A status message will be shown independently after this. Everything here may be translated as makes sense.",
	...
	"TIP_3": {
		"description": "Helpful tip shown to user advertising features. Do not translate the 'ssh' string. 'profile name' may be translated, but make it clear that the 'profile name' is something the user needs to enter/replace (like the angle brackets do in the English string). It is a user-defined description for their saved connections.",
